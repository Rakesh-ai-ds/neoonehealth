...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020617]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#E5E7EB] mb-6 leading-tight">
              Your Health, <span className="bg-gradient-to-r from-[#2563EB] to-[#38BDF8] bg-clip-text text-transparent">Our Priority</span>
            </h1>
      ...
      {/* Stats Bar */}
      <section className="py-8 bg-[#0F172A] border-y border-white/5">
          ...
          >
            {[
              ...
              <motion.div key={index} variants={fadeInUp} className="flex flex-col items-center">
                <stat.icon className="text-[#38BDF8] mb-2" size={28} />
                <p className="text-2xl md:text-3xl font-bold text-[#E5E7EB]">{stat.number}</p>
      ...
      {/* Our Story & Vision */}
      <section className="py-20 bg-[#020617]" ref={storyRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              variants={fadeInLeft}
            >
              <h2 className="text-4xl font-bold text-[#E5E7EB] mb-6">Our Story</h2>
              <p className="text-lg text-[#94A3B8] mb-6">
                NeoOne Health was founded with a simple belief: <strong className="text-[#E5E7EB]">everyone deserves access to quality healthcare</strong>. We started as a small clinic and have grown into a comprehensive healthcare provider serving thousands of families.
              </p>
              <p className="text-lg text-[#94A3B8] mb-6">
          ...
          <motion.div
            className="mt-16 bg-gradient-to-r from-[#2563EB] to-[#38BDF8] p-12 rounded-2xl text-center"
            initial="hidden"
            animate={storyInView ? "visible" : "hidden"}
            variants={fadeInUp}
          >
      ...
      {/* Core Values */}
      <section className="py-20 bg-[#0F172A]" ref={valuesRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <span className="text-[#38BDF8] font-medium text-sm uppercase tracking-wider">What We Believe</span>
            <h2 className="text-4xl font-bold text-[#E5E7EB] mt-2 mb-4">Our Core Values</h2>
            <p className="text-xl text-[#94A3B8]">The principles that guide everything we do</p>
          </motion.div>
          ...
          >
            {values.map((value, index) => (
              <motion.div
                key={index}
                className="bg-[#020617] border border-white/5 p-8 rounded-2xl text-center hover:border-[#2563EB]/30 transition-all"
                variants={fadeInUp}
                whileHover={{ y: -10 }}
              >
                <div className="w-16 h-16 bg-[#2563EB]/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <value.icon className="text-[#38BDF8]" size={32} />
                </div>
                <h3 className="text-2xl font-bold text-[#E5E7EB] mb-4">{value.title}</h3>
      ...
      {/* Leadership Team */}
      <section className="py-20 bg-[#020617]" ref={teamRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            className="text-center mb-16"
            initial="hidden"
            ...
            variants={fadeInUp}
          >
            <span className="text-[#38BDF8] font-medium text-sm uppercase tracking-wider">Meet Our Team</span>
            <h2 className="text-4xl font-bold text-[#E5E7EB] mt-2 mb-4">Leadership & Expertise</h2>
            <p className="text-xl text-[#94A3B8]">Backed by clinical excellence and dedication</p>
          </motion.div>
          ...
          >
            {team.map((member, index) => (
              <motion.div
                key={index}
                className="bg-[#0F172A] border border-white/5 p-8 rounded-2xl text-center group hover:border-[#2563EB]/30 transition-all"
                variants={fadeInUp}
                whileHover={{ y: -10 }}
              >
                ...
                <h3 className="text-xl font-bold text-[#E5E7EB] mb-2">{member.name}</h3>
                <p className="text-[#38BDF8] font-semibold mb-4">{member.role}</p>
                <p className="text-[#94A3B8] text-sm">{member.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
