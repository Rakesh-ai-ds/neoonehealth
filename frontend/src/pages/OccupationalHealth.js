...
const OccupationalHealth = () => {
    ...
    const services = [
        { id: "workplace-safety", title: "Workplace Safety Assessment", icon: HardHat, image: "/images/occupational-health.png", description: "Comprehensive evaluation of your workplace environment to identify health hazards, safety risks, and areas for improvement. We assess physical, biological, and ergonomic factors.", benefits: ["Hazard identification and mitigation", "Compliance with safety regulations", "Reduced workplace injuries", "Improved employee confidence", "Lower insurance costs"] },
